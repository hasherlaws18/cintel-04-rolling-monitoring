...
Terminal command to run this file from the root project folder
    ...
    uv run python -m cintel.rolling_monitor_Asher-Laws-custom
...
DATA_FILE: Final[Path] = DATA_DIR / "system_metrics_timeseries_Asher-Laws.csv"
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "rolling_metrics_Asher-Laws_custom.csv"
...
def main() -> None:
    ...
    # added a rounding decimal to this.
